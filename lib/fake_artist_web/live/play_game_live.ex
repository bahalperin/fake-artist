defmodule FakeArtistWeb.PlayGameLive do
  ...
  def handle_event("select_word", _params, socket) do
    {:noreply, assign(socket, game: socket.assigns.game |> Game.choose_category_and_word(%{ word: "apple", category: "food", user_id: socket.assigns.session_id })) }
  end

  def handle_event("submit_drawing", _params, socket) do
    {:noreply, assign(socket, game: socket.assigns.game |> Game.submit_drawing(%{
  ...
  def handle_event("vote", _params, socket) do
    {:noreply, assign(socket, game: socket.assigns.game |> Game.submit_vote(%{
      user_id: socket.assigns.session_id,
